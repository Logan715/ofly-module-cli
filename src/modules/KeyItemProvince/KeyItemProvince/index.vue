<template>
  <div>
      ...
      <el-col :span="24">
        ...
        >
          <template #toolbar_right>
            <KeyItemProvinceToolBarOperation
    ...
    <KeyItemProvinceReviewListModal
...
import KeyItemProvinceEditModal from "./views/KeyItemProvinceEditModal.vue";
import KeyItemProvinceReviewListModal from "../KeyItemProvinceReview/KeyItemProvinceReviewListModal.vue";
...
import KeyItemProvinceRowOperation from './views/KeyItemProvinceRowOperation.vue'
import KeyItemProvinceToolBarOperation from './views/KeyItemProvinceToolBarOperation.vue';
